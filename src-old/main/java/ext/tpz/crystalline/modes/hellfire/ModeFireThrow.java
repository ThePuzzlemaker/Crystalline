package ext.tpz.crystalline.modes.hellfire;
...
public class ModeFireThrow implements ICrystalMode {

    @Override
    public String getUnlocalizedName() {
        return "crystalline.mode.fire_throw";
    }
    ...
    public ActionResult<ItemStack> use(ItemStack crystal, EntityPlayer player) {
        if (CrystallineItems.crystal.getReagent(crystal).consume(player, crystal)) {
            ...
            EntityFireThrow eOB = new EntityFireThrow(player.getEntityWorld(), player);
    ...
    public List<ICrystal> getValidCrystals() {
        return Lists.newArrayList(BaseModCrystals.hellfire_crystal);
    }
    ...
    public ResourceLocation getRegistryName() {
        return new ResourceLocation(Reference.MODID, "mode.fire_throw");
    }
