...
public class EssenceLiquidAtmosburst implements IEssenceLiquid {

    @Override
    public String getUnlocalizedName() {
        return "crystalline.essence.liquid.atmosburst";
    }

    @Nullable
    @Override
    public ResourceLocation getRegistryName() {
        return new ResourceLocation(Reference.MODID + ":essence.liquid.atmosburst");
    }
    ...
    public ModelResourceLocation getModel() {
        return new ModelResourceLocation(Reference.BOTTLE_MODEL_BASE + ".atmosburst");
    }

    @Override
    public ICrystal getEquivalent() {
        return BaseModCrystals.atmosburst_crystal;
    }
