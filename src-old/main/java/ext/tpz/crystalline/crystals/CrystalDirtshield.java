...
public class CrystalDirtshield implements ICrystal {

    @Override
    public String getUnlocalizedName() {
        return "crystalline.crystal.dirtshield";
    }
    ...
    public List<ICrystalMode> getModes() {
        return Lists.newArrayList(BaseModModes.mode_null, BaseModModes.dirt_shield);
    }

    @Override
    public ModelResourceLocation getModel() {
        return new ModelResourceLocation(Reference.CRYSTAL_MODEL_BASE + ".dirtshield");
    }
    ...
    public ResourceLocation getRegistryName() {
        return new ResourceLocation(Reference.MODID, "crystal.dirtshield");
    }
