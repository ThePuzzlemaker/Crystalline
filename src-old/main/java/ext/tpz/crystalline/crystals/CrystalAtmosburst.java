...
public class CrystalAtmosburst implements ICrystal {

    @Override
    public String getUnlocalizedName() {
        return "crystalline.crystal.atmosburst";
    }
    ...
    public List<ICrystalMode> getModes() {
        return Lists.newArrayList(BaseModModes.mode_null, BaseModModes.atmos_burst);
    }

    @Override
    public ModelResourceLocation getModel() {
        return new ModelResourceLocation(Reference.CRYSTAL_MODEL_BASE + ".atmosburst");
    }
    ...
    public ResourceLocation getRegistryName() {
        return new ResourceLocation(Reference.MODID, "crystal.atmosburst");
    }
